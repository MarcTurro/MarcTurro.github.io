...
figure_4 = PyodidePlot('cible_4')  # Disponible après l'import de matplotlib
figure_4.target()
...
# Créer le graphe en utilisant la classe `Graphe` déjà présente dans le code caché
mon_graphe = ...

# Ajouter des arêtes
...

# Récupérer le dictionnaire liste d'adjacence
adjacences = ...

print(adjacences)
plt.cla()  # Pour effacer la figure
graphe_nx = cree_graphe_non_oriente_nx(adjacences)
nx.draw_circular(graphe_nx, with_labels = True)
plt.show()
